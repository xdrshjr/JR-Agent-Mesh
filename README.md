...
- **Conversation Management** — Persistent chat history with create, rename, delete, and full database import/export
- **Credential Management** — AES-256-GCM encrypted storage for API keys with per-provider test-connection support
...
- **Agent Dispatch Mode** — Let the built-in assistant automatically delegate tasks to running coding agents
...
server/                  Express + WebSocket backend
  ...
  services/              Self-agent, agent process manager, agent registry, file transfer
